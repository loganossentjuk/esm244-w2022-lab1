...
blackwood_acacia_df <- sf_trees %>% 
  filter(str_detect(species, 'Blacwood Acacia')) %>%  #str_detect finds a given string within a row even if there is other text within it 
  select(legal_status, data, lat = latitude, lon = longitude)
